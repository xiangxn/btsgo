...
class TotalValue extends React.Component {
    ...
    shouldComponentUpdate(nextProps) {
        return (
            ...
            nextProps.toAsset !== this.props.toAsset || !utils.are_equal_shallow(nextProps.balances, this.props.balances) || !utils.are_equal_shallow(nextProps.openOrders, this.props.openOrders) || !utils.are_equal_shallow(nextProps.collateral, this.props.collateral) || !utils.are_equal_shallow(nextProps.debt, this.props.debt)
        );
    }
...
ValueStoreWrapper = connectToStores(ValueStoreWrapper);
...
class AccountWrapper extends React.Component {
    ...
    render() {
        ...
        return balanceList.size ?
            <TotalBalanceValue inHeader={this.props.inHeader} balances={balanceList} openOrders={openOrders} debt={debt}
